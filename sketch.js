...
function setup() {
    ...
    bobObject1 = new Bob(200,600,60);
    bobObject2 = new Bob(300,600,60);
    bobObject3 = new Bob(400,600,60);
    bobObject4 = new Bob(500,600,60);
    bobObject5 = new Bob(600,600,60);
    roof = new Roof(300,10,600,20)
